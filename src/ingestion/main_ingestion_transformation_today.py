...
if __name__ == '__main__':
    ...
    while  True:
        ...
        commandlist=[
            r"C:\src\assetflow\.venv\Scripts\activate.bat",
            r"cd C:\src\assetflow\src\transformation",
            f"dbt run --select tag:fact_table"
        ]
        console.print("Executing transformation pipeline...", style="bold green")
        os.system(" & ".join(commandlist))
        console.print("Transformation pipeline  execution completed!", style="bold green")
